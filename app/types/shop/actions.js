...
export const FETCH_PAY_START: 'shop/fetch-pay:start' = 'shop/fetch-pay:start';
export const FETCH_PAY_END: 'shop/fetch-pay:end' = 'shop/fetch-pay:end';
...
export const SET_USERNAME: 'shop/set-username' = 'shop/set-username';
